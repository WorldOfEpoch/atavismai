...
namespace Atavism
{
    ...
    public class ClientAPI : MonoBehaviour
    {
      ...
      //  [HideInInspector]staticSyncPositionDiffTolerance
        ...
        public bool UiElementFocused = false;

        public long totalSent = 0L;
        public long totalReceived = 0L;
        public long totalPropertyReceived = 0L;
        void Awake()
        {
        ...
        {
            // Debug.LogError("UIHasFocus "+Instance.UiElementFocused);
            if (EventSystem.current.currentSelectedGameObject != null && (EventSystem.current.currentSelectedGameObject.GetComponent<InputField>() != null
                || EventSystem.current.currentSelectedGameObject.GetComponent<TMP_InputField>() != null) || Instance.UiElementFocused)
                return true;
            return false;
        }
        ...
        private void Update()
        {
            totalReceived = AtavismRdpConnection.TotalBytesReceivedCounter;
               totalSent = AtavismRdpConnection.TotalBytesSentCounter;
               totalPropertyReceived = AtavismRdpConnection.TotalBytesPropertyReceivedCounter;
           }
