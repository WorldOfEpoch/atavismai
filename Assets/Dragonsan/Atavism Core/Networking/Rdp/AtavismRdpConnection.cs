...
namespace Atavism
{
    ...
    public class AtavismRdpConnection
    {
        ...
        static long totalBytesPropertySentCount = 0;
        static long totalBytesPropertyReceivedCount = 0;
        ...
        public static long TotalBytesPropertySentCounter
        {
            get
            {
                return totalBytesPropertySentCount;
            }
        }
        public static long TotalBytesPropertyReceivedCounter
        {
            get
            {
                return totalBytesPropertyReceivedCount;
            }
            set => totalBytesPropertyReceivedCount = value;
        }
