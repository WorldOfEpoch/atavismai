...
{
    public class UIAtavismDialogPopupManager : MonoBehaviour
    {
        private static UIAtavismDialogPopupManager instance;
        public static UIAtavismDialogPopupManager Instance => instance;
        ...
        public bool ShowDialogPopup(string message, Action confirm, string confirmButton = "OK", Action cancel = null, string cancelButton = "CLOSE")
        {
            ...
            {
                HideDialogPopup();
                //Debug.LogError("Cannot show popup dialog because it is already visible!");
                //return false;
            }
