...
public abstract class AtavismListUXML<VisualElement> : MonoBehaviour 
{
    ...
    protected virtual void BindDataToElement(LootListEntryUXML element, LootListEntryUXML data)
    {
