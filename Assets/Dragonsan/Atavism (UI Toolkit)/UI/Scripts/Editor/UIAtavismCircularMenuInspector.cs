...
{
    [CustomEditor(typeof(UIAtavismCircularMenu))]
    public class UIAtavismCircularMenuInspector : UnityEditor.Editor
    {
        #region Fields

        private UIAtavismCircularMenu Target;
        ...
        {
            Target = (UIAtavismCircularMenu)target;
         }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (InputsFoldout)
            {
                ...
                if (Target.Controller == UIAtavismCircularMenu.ControllerType.Gamepad)
                {
            ...
            if (CategoriesFoldout)
            {
                ...
                for (int i = 0; i < Target.Categories.Count; i++)
                {
                    ...
                    Target.Categories[i].ContentName = EditorGUILayout.TextField("Category Content Object Name :", Target.Categories[i].ContentName);
                    ...
                    if (GUILayout.Button("Pieces Collection To Buttons"))
                    {
                        if (BuildManager.Instance != null)
                        {
                            if (BuildManager.Instance.Pieces != null)
                            {
                                ...
                                {
                                    Target.Categories[i].Buttons.Add(new UIAtavismCircularButtonData() {
                ...
                {
                    Target.Categories.Add(new UIAtavismCircularMenu.UICustomCategory() { Name = CategoryName, ContentName = CategoryName });
