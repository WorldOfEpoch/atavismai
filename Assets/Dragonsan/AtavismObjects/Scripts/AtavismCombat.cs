    ...
    public class AtavismCombat : MonoBehaviour
    {
      ...
      /*  [SerializeField]  string manaStat = "mana";
       ...
       // [SerializeField] static string healthStat = "health";
        ...
        {
            Debug.LogError("HandleDuelChallenge");
            string challenger = (string)props["challenger"];
#if AT_I2LOC_PRESET
        if(UGUIConfirmationPanel.Instance!=null) UGUIConfirmationPanel.Instance.ShowConfirmationBox(challenger + " " + I2.Loc.LocalizationManager.GetTranslation("has challenged you to a Duel. Do you accept the challenge?"), null, DuelChallengeResponse, 30f);
       if(UIAtavismConfirmationPanel.Instance!=null) UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(challenger + " " + I2.Loc.LocalizationManager.GetTranslation("has challenged you to a Duel. Do you accept the challenge?"), null, DuelChallengeResponse, 30f);
#else
            if(UGUIConfirmationPanel.Instance!=null)   UGUIConfirmationPanel.Instance.ShowConfirmationBox(challenger + " has challenged you to a Duel. Do you accept the challenge?", null, DuelChallengeResponse);
            if(UIAtavismConfirmationPanel.Instance!=null)UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(challenger + " has challenged you to a Duel. Do you accept the challenge?", null, DuelChallengeResponse);
#endif
        }
