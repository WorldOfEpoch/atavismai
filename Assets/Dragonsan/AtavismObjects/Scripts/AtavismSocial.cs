...
namespace Atavism
{
    ...
    public class AtavismSocial : MonoBehaviour
    {
		...
		string inviteMessage = inviterName + " "+I2.Loc.LocalizationManager.GetTranslation("has invited you to join Private Instance");
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)  UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(inviteMessage, inviterOid, PrivateInviteResponse,timeOut);
        }
        ...
        public void HandleCancelInviteRequest(Dictionary<string, object> props)
        {
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.Hide();
        }
...
#if AT_I2LOC_PRESET
       if(UGUIConfirmationPanel.Instance!=null)  UGUIConfirmationPanel.Instance.ShowConfirmationBox(inviterName + " " + I2.Loc.LocalizationManager.GetTranslation("has invited you to be a friend"), inviterOid, InviteResponse,(float)count);
       if(UIAtavismConfirmationPanel.Instance!=null)  UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(inviterName + " " + I2.Loc.LocalizationManager.GetTranslation("has invited you to be a friend"), inviterOid, InviteResponse,(float)count);
#else
            if(UGUIConfirmationPanel.Instance!=null)   UGUIConfirmationPanel.Instance.ShowConfirmationBox(inviterName + " " + "has invited you to be a friend", inviterOid, InviteResponse, (float)count);
            if(UIAtavismConfirmationPanel.Instance!=null)   UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(inviterName + " " + "has invited you to be a friend", inviterOid, InviteResponse, (float)count);
#endif
        }
