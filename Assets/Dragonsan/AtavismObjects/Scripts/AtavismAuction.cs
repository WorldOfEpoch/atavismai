...
namespace Atavism
{
    ...
    public class AtavismAuction : MonoBehaviour
    {
        ...
        else
        {
            ...
            // dic += "]";
            //
            // Debug.LogError("SearchAuction Start "+sortCount+" "+  sortName+" "+ sortPrice+" "+ searchQuality+" "+ searchRace+" "+ searchClass+" "+ searchLevelMin+" "+ searchLevelMax+" "+
            //                searchCatType+" "+ searchCat+" "+ searchText+" "+ string.Join(",", searchQualityList)+" "+ asc+" "+ dic);
