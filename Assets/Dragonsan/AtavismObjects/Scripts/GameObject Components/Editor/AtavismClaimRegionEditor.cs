      ...
      int[] optionsClaimTypeIds;
        ...
        public override void OnInspectorGUI()
        {
          ...
          //  var indentOffset = EditorGUI.indentLevel * 5f;
            ...
            {
                AtavismEditorFunctions.LoadAtavismChoiceOptions("Claim Type", false, out optionsClaimTypeIds, out optionsClaimType);
            }
            ...
            if (!profileLoaded)
            {
                AtavismEditorFunctions.LoadClaimObjectLimitProfile();
              profileLoaded = true;
            }
            ...
            obj.object_limit_profile = AtavismEditorFunctions.GetFilteredListSelector(content, ref profileSearch, obj.object_limit_profile, AtavismEditorFunctions.claimProfileOptions, AtavismEditorFunctions.claimProfileIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            obj.purchaseCurrency = EditorGUILayout.IntPopup(content, obj.purchaseCurrency, AtavismEditorFunctions.GuiCurrencyOptions, AtavismEditorFunctions.currencyIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            for (int i = 0; i < obj.deedItemIDs.Count; i++)
            {
                ...
                obj.deedItemIDs[i] = AtavismEditorFunctions.GetFilteredListSelector(content, ref search, obj.deedItemIDs[i], AtavismEditorFunctions.GuiItemsList, AtavismEditorFunctions.itemIds);
            ...
            obj.taxCurrency = EditorGUILayout.IntPopup(content, obj.taxCurrency, AtavismEditorFunctions.GuiCurrencyOptions, AtavismEditorFunctions.currencyIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
         ...
         //  GUILayout.Space(20);
            ...
            for (int i = 0; i < obj.upgrades.Count; i++)
            {
                ...
                obj.upgrades[i].object_limit_profile= AtavismEditorFunctions.GetFilteredListSelector(content, ref search, obj.upgrades[i].object_limit_profile, AtavismEditorFunctions.claimProfileOptions, AtavismEditorFunctions.claimProfileIds);
                //   obj.deedItemIDs[i] = (int)EditorGUILayout.IntPopup(content, obj.deedItemIDs[i], ServerCharacter.GuiItemsList, ServerCharacter.itemIds);
               ...
               // obj.upgrades[i].object_limit_profile = EditorGUILayout.IntPopup(content, obj.upgrades[i].object_limit_profile, ServerInstanceObjects.claimProfileOptions, ServerInstanceObjects.claimProfileIds);
                ...
                obj.upgrades[i].currency = EditorGUILayout.IntPopup(content, obj.upgrades[i].currency, AtavismEditorFunctions.GuiCurrencyOptions, AtavismEditorFunctions.currencyIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
                ...
                for (int k = 0; k < obj.upgrades[i].deedItemIDs.Count; k++)
                {
                    ...
                    obj.upgrades[i].deedItemIDs[k] = AtavismEditorFunctions.GetFilteredListSelector(content, ref search, obj.upgrades[i].deedItemIDs[k], AtavismEditorFunctions.GuiItemsList, AtavismEditorFunctions.itemIds);
                    //   obj.deedItemIDs[i] = (int)EditorGUILayout.IntPopup(content, obj.deedItemIDs[i], ServerCharacter.GuiItemsList, ServerCharacter.itemIds);
                ...
                content = new GUIContent("Currency:");
                content.tooltip = "Tax Currency:";
                obj.upgrades[i].taxCurrency = EditorGUILayout.IntPopup(content, obj.upgrades[i].taxCurrency, AtavismEditorFunctions.GuiCurrencyOptions, AtavismEditorFunctions.currencyIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
                content = new GUIContent("Cost:");
                content.tooltip = "Tax Cost:";
