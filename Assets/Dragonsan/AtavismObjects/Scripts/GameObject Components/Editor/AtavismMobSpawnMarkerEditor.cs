...
namespace Atavism
{
    ...
    public class AtavismMobSpawnMarkerEditor : Editor
    {
        ...
        SerializedProperty roamDelayMin;
        SerializedProperty roamDelayMax;
        SerializedProperty roamRollTimeEachTime;
        ...
        private void OnEnable()
        {
            ...
            roamDelayMin = serializedObject.FindProperty("roamDelayMin");
            roamDelayMax = serializedObject.FindProperty("roamDelayMax");
            roamRollTimeEachTime = serializedObject.FindProperty("roamRollTimeEachTime");
        ...
        public override void OnInspectorGUI()
        {
          ...
          //  var indentOffset = EditorGUI.indentLevel * 5f;
            ...
            {
                AtavismEditorFunctions.LoadMobOptions(true);
            ...
            mobTemplateID.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch, mobTemplateID.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            mobTemplateID2.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch2, mobTemplateID2.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            mobTemplateID3.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch3, mobTemplateID3.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            mobTemplateID4.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch4, mobTemplateID4.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            mobTemplateID5.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch5, mobTemplateID5.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
...
*/
           ...
           // EditorGUILayout.LabelField("Time Based Spawn Rules");
            ...
            alternateMobTemplateID.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch, alternateMobTemplateID.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            alternateMobTemplateID2.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch2, alternateMobTemplateID2.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            alternateMobTemplateID3.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch3, alternateMobTemplateID3.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            alternateMobTemplateID4.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch4, alternateMobTemplateID4.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            alternateMobTemplateID5.intValue = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch5, alternateMobTemplateID5.intValue, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content = new GUIContent("Roam Delay Min");
            content.tooltip = "Roam Delay Min";
            roamDelayMin.floatValue = EditorGUILayout.FloatField(content, roamDelayMin.floatValue);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);

            content = new GUIContent("Roam Delay Max");
            content.tooltip = "Roam Delay Max";
            roamDelayMax.floatValue = EditorGUILayout.FloatField(content, roamDelayMax.floatValue);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);

            content = new GUIContent("Roam Roll Time Each Time");
            content.tooltip = "Roam Roll Time Each Time";
            roamRollTimeEachTime.boolValue = EditorGUILayout.Toggle(content, roamRollTimeEachTime.boolValue);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            {
                startsQuests[i] = EditorGUILayout.IntPopup(new GUIContent(), startsQuests[i], AtavismEditorFunctions.GuiQuestOptions, AtavismEditorFunctions.questIds);
            }
            ...
            int newQuest = AtavismEditorFunctions.GetFilteredListSelector(new GUIContent(), ref obj.startsQuestsSearch, -1, AtavismEditorFunctions.GuiQuestOptions, AtavismEditorFunctions.questIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            if (newQuest > 0)
            {
           ...
           content = new GUIContent("Ends Quests");
            ...
            {
                endsQuests[i] = EditorGUILayout.IntPopup(new GUIContent(), endsQuests[i], AtavismEditorFunctions.GuiQuestOptions, AtavismEditorFunctions.questIds);
            }
            endsQuests.Remove(-1);
            ...
            obj.endsQuestsSearch = EditorGUILayout.TextField(content, obj.endsQuestsSearch);
             ...
             newQuest = AtavismEditorFunctions.GetFilteredListSelector(new GUIContent(), ref obj.endsQuestsSearch, -1,  AtavismEditorFunctions.GuiQuestOptions, AtavismEditorFunctions.questIds);
            if (newQuest > 0)
            {
            ...
            if (!dialoguesLoaded)
                AtavismEditorFunctions.LoadOpeningDialogueList(true);
            ...
            {
                dialogues[i] = EditorGUILayout.IntPopup(new GUIContent(), dialogues[i], AtavismEditorFunctions.GuiDialogueList, AtavismEditorFunctions.dialogueIds);
            } 
            dialogues.Remove(-1);
            ...
            obj.startsDialoguesSearch = EditorGUILayout.TextField(content, obj.startsDialoguesSearch);
             ...
             newQuest = AtavismEditorFunctions.GetFilteredListSelector(new GUIContent(), ref obj.startsDialoguesSearch, -1,  AtavismEditorFunctions.GuiDialogueList, AtavismEditorFunctions.dialogueIds);
            if (newQuest > 0)
            {
            ...
            if (!merchantTablesLoaded)
                AtavismEditorFunctions.LoadMerchantTableList(true);
            merchantTablesLoaded = true;

            content = new GUIContent("Merchant Table");
            content.tooltip = "Merchant Table";
            merchantTable.intValue = EditorGUILayout.IntPopup(content, merchantTable.intValue, AtavismEditorFunctions.GuiMerchantTableList, AtavismEditorFunctions.merchantTableIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
