        ...
        public override void OnInspectorGUI()
        {
          //  var indentOffset = EditorGUI.indentLevel * 5f;
            ...
            if (obj.regionType == AtavismRegionType.Water)
            {
                ...
                obj.actionID = EditorGUILayout.IntPopup(content, obj.actionID, AtavismEditorFunctions.GuiEffectOptions, AtavismEditorFunctions.effectIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            }
            ...
            else if (obj.regionType == AtavismRegionType.StartQuest)
            {
                ...
                obj.actionID = EditorGUILayout.IntPopup(content, obj.actionID, AtavismEditorFunctions.GuiQuestOptions, AtavismEditorFunctions.questIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            }
            else if (obj.regionType == AtavismRegionType.CompleteTask)
            {
                ...
                obj.actionID = EditorGUILayout.IntPopup(content, obj.actionID, AtavismEditorFunctions.GuiTaskOptions, AtavismEditorFunctions.taskIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            }
            else if (obj.regionType == AtavismRegionType.Teleport)
            {
                ...
                obj.actionID = EditorGUILayout.IntPopup(content, obj.actionID, AtavismEditorFunctions.GuiInstanceList, AtavismEditorFunctions.instanceIds);
                if (help)
                    EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
