    ...
    public class GraveyardEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
          //  var indentOffset = EditorGUI.indentLevel * 5f;
            ...
            if (!factionLoaded)
            {
                AtavismEditorFunctions.LoadFactionOptions(true);
                factionLoaded = true;
            }
                obj.factionID = EditorGUILayout.IntPopup(content, obj.factionID, AtavismEditorFunctions.GuiFactionOptions, AtavismEditorFunctions.factionIds);
