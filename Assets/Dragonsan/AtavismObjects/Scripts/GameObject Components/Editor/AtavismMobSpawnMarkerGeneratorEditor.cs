...
*/
          EditorGUI.BeginChangeCheck();
            ...
            obj.mobTemplateID = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch, obj.mobTemplateID, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            obj.mobTemplateID2 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch2, obj.mobTemplateID2, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            obj.mobTemplateID3 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch3, obj.mobTemplateID3, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            obj.mobTemplateID4 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch4, obj.mobTemplateID4, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Mob Template";
            obj.mobTemplateID5 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.mobTemplateSearch5, obj.mobTemplateID5, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
...
*/
           ...
           // EditorGUILayout.LabelField("Time Based Spawn Rules");
            ...
            obj.alternateMobTemplateID = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch, obj.alternateMobTemplateID, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            obj.alternateMobTemplateID2 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch2, obj.alternateMobTemplateID2, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            obj.alternateMobTemplateID3 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch3, obj.alternateMobTemplateID3, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            obj.alternateMobTemplateID4 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch4, obj.alternateMobTemplateID4, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            content.tooltip = "Select Alternate Spawn Mob Template";
            obj.alternateMobTemplateID5 = AtavismEditorFunctions.GetFilteredListSelector(content, ref obj.alternateMobTemplateSearch5, obj.alternateMobTemplateID5, AtavismEditorFunctions.GuiMobOptions, AtavismEditorFunctions.mobIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            obj.roamDelayMin = EditorGUILayout.FloatField(content, obj.roamDelayMin);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);

            content = new GUIContent("Roam Delay Max");
            content.tooltip = "Roam Delay Max";
            obj. roamDelayMax = EditorGUILayout.FloatField(content, obj.roamDelayMax);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);

            content = new GUIContent("Roam Roll Time Each Time");
            content.tooltip = "Roam Roll Time Each Time";
            obj.roamRollTimeEachTime = EditorGUILayout.Toggle(content, obj.roamRollTimeEachTime);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
           ...
           content = new GUIContent("Ends Quests");
            ...
            obj.merchantTable = EditorGUILayout.IntPopup(content, obj.merchantTable, AtavismEditorFunctions.GuiMerchantTableList, AtavismEditorFunctions.merchantTableIds);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
          ...
          //  obj.mesh = (Mesh) EditorGUILayout.ObjectField(content, obj.mesh,typeof(Mesh));
            ...
            {
                obj.Clear();
                Mob mob = AtavismEditorFunctions.LoadMobTemplateModel(obj.mobTemplateID);
