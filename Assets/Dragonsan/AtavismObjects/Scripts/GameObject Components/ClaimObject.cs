    ...
    public class ClaimObject : MonoBehaviour
    {
        ...
        public bool InteractiveCheck()
        {
           ...
           // return true;
            ...
            {
                Debug.LogWarning("no permition");
                return false;
            }
            if (WorldBuilder.Instance.BuildingState == WorldBuildingState.CreateObject || WorldBuilder.Instance.BuildingState == WorldBuildingState.PlaceItem)
            {
                Debug.LogWarning("Place / create");
                return false;
            }
       ...
       else
       {
        ...
        void Update()
        {
            ...
            if (mouseOver && (/*Input.GetMouseButtonDown(1) ||*/ (WorldBuilder.Instance.BuildingState == WorldBuildingState.SelectItem && Input.GetMouseButtonDown(0))) && ((UGUIWorldBuilder.Instance!=null && UGUIWorldBuilder.Instance.Showing)||(UIAtavismWorldBuilder.Instance!=null && UIAtavismWorldBuilder.Instance.Showing)))
            {
            ...
            if (WorldBuilder.Instance.SelectedObject != null)
            {
                ...
                {
                    if(UGUIWorldBuilder.Instance!=null) UGUIWorldBuilder.Instance.SaveObjectChanges();
                    if(UIAtavismWorldBuilder.Instance!=null) UIAtavismWorldBuilder.Instance.SaveObjectChanges();
                }
            }
            if (UGUIWorldBuilder.Instance!=null && UGUIWorldBuilder.Instance.Showing == true)
            {
