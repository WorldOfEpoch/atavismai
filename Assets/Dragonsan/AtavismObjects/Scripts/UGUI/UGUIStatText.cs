        ...
        void Start()
        {
            ...
            if (ClientAPI.GetPlayerObject() != null)
            {
                ...
                if (ClientAPI.GetPlayerObject().PropertyExists(prop))
                {
                    ...
                    if (text != null)
                        text.text = "" + AtavismPrefabManager.Instance.GetStatValueWithPrecision(prop, value);
                    if (TMPText != null)
                        TMPText.text = "" + AtavismPrefabManager.Instance.GetStatValueWithPrecision(prop, value);
                }
            }
        }
