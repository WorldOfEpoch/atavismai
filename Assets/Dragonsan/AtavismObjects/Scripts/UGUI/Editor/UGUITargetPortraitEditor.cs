    ...
    public class UGUITargetPortraitEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
           ...
           // GUILayout.Space(20);
            ...
            content = new GUIContent("Pet Info button");
            content.tooltip = "Select Pet Info button";
            obj.petInfoButton = (Button)EditorGUILayout.ObjectField(content, obj.petInfoButton, typeof(Button), true);
            if (help)
                EditorGUILayout.HelpBox(content.tooltip, MessageType.None);
            ...
            if (mobTypes == null)
            {
              ...
              AtavismEditorFunctions.LoadAtavismChoiceOptions("Mob Type", false, out mobTypesIds,out mobTypes);
            }
