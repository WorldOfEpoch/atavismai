...
//            Debug.LogError("claimObject selected  claimId=" +claimId+" objId="+objId);
            ...
            if (petInfoButton != null)
                petInfoButton.gameObject.SetActive(false);
        ...
        public void UpdatePortrait()
        {
         ...
         /*   if (name != null)
                ...
                if (node != null)
                {
                    ...
                    if (petDespawnButton != null)
                            ...
                            ((OID)node.GetProperty("petOwner")).Equals(OID.fromLong(ClientAPI.GetPlayerOid())))
                        {
                            ...
                            if (petInfoButton != null)
                                petInfoButton.gameObject.SetActive(true);
                            if (WhisperButton != null)
                                WhisperButton.gameObject.SetActive(false);
                            if (InviteGroupButton != null)
                                InviteGroupButton.gameObject.SetActive(false);
            ...
            if (levelText != null)
            {
                ...
                if (isPet)
                {
                    level = (int)ClientAPI.GetTargetObject().GetProperty(PROPS.PET_LEVEL);
                }
        ...
        {
            UGUIOtherCharacterPanel.Instance.UpdateCharacterData(ClientAPI.GetTargetOid());
            popupMenu.gameObject.SetActive(false);
            AtavismSettings.Instance.DsContextMenu(null);
        }
        public void PetInfoOptionClicked()
        {
            UGUIPetCharacterPanel.Instance.UpdateCharacterData(ClientAPI.GetTargetOid());
            popupMenu.gameObject.SetActive(false);
            AtavismSettings.Instance.DsContextMenu(null);
        }
