...
namespace Atavism
{
    public class UGUIMobCreator : MonoBehaviour
    {
        ...
        [SerializeField] TMP_InputField roamDelayMinInput;
        [SerializeField] TMP_InputField roamDelayMaxInput;
        [SerializeField] Toggle roamRollTimeEachTime;
        ...
        void ShowSpawnMob()
        {
           ...
           if(roamDelayMinInput) roamDelayMinInput.text = spawnInCreation.roamDelayMin.ToString("N1");
           if(roamDelayMaxInput) roamDelayMaxInput.text = spawnInCreation.roamDelayMax.ToString("N1");
           if(roamRollTimeEachTime) roamRollTimeEachTime.isOn = spawnInCreation.roamRollTimeEachTime;
        ...
        public void SpawnMobHere()
        {
            ...
            if(roamDelayMinInput) spawnInCreation.roamDelayMin = float.Parse(roamDelayMinInput.text);
            if(roamDelayMaxInput) spawnInCreation.roamDelayMax = float.Parse(roamDelayMaxInput.text);
            if(roamRollTimeEachTime) spawnInCreation.roamRollTimeEachTime = roamRollTimeEachTime.isOn;
