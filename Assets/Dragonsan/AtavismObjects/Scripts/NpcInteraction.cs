...
namespace Atavism
{
    ...
    public class NpcInteraction : MonoBehaviour
    {
        ...
        [SerializeField] private float npcMaxDistance = 5f;
        ...
        void Update()
        {
            ...
            {
                if (Vector3.Distance(ClientAPI.GetPlayerObject().Position, ClientAPI.GetObjectNode(NpcId.ToLong()).GameObject.transform.position) > npcMaxDistance)
                {
                    NpcId = null;
        ...
        public void SellItemToMerchant(AtavismInventoryItem item)
        {
         ...
         //   Debug.LogError("Sell am=" + amount);
           ...
           // Debug.LogError("Sell Final fp=" + fprice);
...
#if AT_I2LOC_PRESET
            if(UGUIConfirmationPanel.Instance!=null)
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(I2.Loc.LocalizationManager.GetTranslation("Do you want to sell") + " " + I2.Loc.LocalizationManager.GetTranslation("Items/" + item.name) + " " + I2.Loc.LocalizationManager.GetTranslation("for") + " " + costString + "?", item, SellItemConfirmed);
#else
            if(UGUIConfirmationPanel.Instance!=null)
                UGUIConfirmationPanel.Instance.ShowConfirmationBox("Do you want to sell " + item.name + " for " + costString + "?", item, SellItemConfirmed);
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox("Do you want to sell " + item.name + " for " + costString + "?", item, SellItemConfirmed);
#endif
        }
        ...
        public void RepairItem(AtavismInventoryItem item)
        {
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(I2.Loc.LocalizationManager.GetTranslation("Do you want to repair") + " " + I2.Loc.LocalizationManager.GetTranslation("Items/" + item.name) + " for " + costString + "?", item, RepairItemConfirmed);
#else
            if(UGUIConfirmationPanel.Instance!=null)
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox("Do you want to repair " + item.name + " for " + costString + "?", item, RepairItemConfirmed);
#endif
        }
        ...
        public void RepairItems(List<AtavismInventoryItem> items)
        {
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(I2.Loc.LocalizationManager.GetTranslation("Do you want to repair these items for") + " " + costString + "?", items, RepairItemsConfirmed);
#else
            if(UGUIConfirmationPanel.Instance!=null)
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox("Do you want to repair these items for " + costString + "?", items, RepairItemsConfirmed);
        ...
        public void RepairAllItems()
        {
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox(I2.Loc.LocalizationManager.GetTranslation("Do you want to repair all items for") + " " + costString + "?", null, RepairAllItemsConfirmed);
#else
            if(UGUIConfirmationPanel.Instance!=null)
            ...
            if(UIAtavismConfirmationPanel.Instance!=null)
                UIAtavismConfirmationPanel.Instance.ShowConfirmationBox("Do you want to repair all items for " + costString + "?", null, RepairAllItemsConfirmed);
#endif
        }
