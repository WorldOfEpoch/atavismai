...
namespace Atavism
{
    public class MobSpawnData : DataStructure
    {
        ...
        public float roamDelayMin = 5;//sec
        public float roamDelayMax = 5;//sec
        ...
        public override string GetValue(string fieldKey)
        {
            switch (fieldKey)
            {
                ...
                case "roamDelayMin":
                    return roamDelayMin.ToString();
                case "roamDelayMax":
                    return roamDelayMax.ToString();
                case "roamRollTimeEachTime":
                    return roamRollTimeEachTime.ToString();
                case "patrolPath":
