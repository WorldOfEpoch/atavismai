...
public class Demo_ThirdPersonController : MonoBehaviour
{
    ...
    private void UpdateAnimator(Vector3 move)
    {
        ...
        if (!IsGrounded)
        {
            AnimatorComponent.SetFloat("Jump", RigidbodyComponent.linearVelocity.y);
        }
    ...
    private void HandleAirborneMovement()
    {
        ...
        GroundCheckDistance = RigidbodyComponent.linearVelocity.y < 0 ? OriginGroundCheckDistance : 0.01f;
    }
    ...
    private void HandleGroundedMovement(bool crouch, bool jump)
    {
        ...
        {
            RigidbodyComponent.linearVelocity = new Vector3(RigidbodyComponent.linearVelocity.x, JumpPower, RigidbodyComponent.linearVelocity.z);
            IsGrounded = false;
    ...
    public void OnAnimatorMove()
    {
        if (IsGrounded && Time.deltaTime > 0)
        {
            ...
            v.y = RigidbodyComponent.linearVelocity.y;
