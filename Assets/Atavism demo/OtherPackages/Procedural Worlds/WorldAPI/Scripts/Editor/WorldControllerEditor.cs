...
namespace WAPI
{
    ...
    public class WorldControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            float rainPowerTerrain = EditorGUILayout.Slider(GetLabel("Rain Power Terrain"), WorldManager.Instance.RainPowerTerrain, 0f, 1f);
            DrawHelpLabel("Rain Power Terrain");

            float snowPower = EditorGUILayout.Slider(GetLabel("Snow Power"), WorldManager.Instance.SnowPower, 0f, 1f);
            DrawHelpLabel("Snow Power");

            float snowPowerTerrain = EditorGUILayout.Slider(GetLabel("Snow Power Terrein"), WorldManager.Instance.SnowPowerTerrain, 0f, 1f);
            DrawHelpLabel("Snow Power Terrein");
...
*/
        ...
        static Dictionary<string, string> m_tooltips = new Dictionary<string, string>
        {
            ...
            { "Rain Power Terrain", "The power of the rain on terrain. This modifies texture smoothness to simulate the effect of rain."},
            { "Snow Power", "The power of the snow. This controls the strength of the snow setting applied."},
            { "Snow Power Terrain", "The power of the snow on terrain. This controls the strength of the snow setting applied."},
