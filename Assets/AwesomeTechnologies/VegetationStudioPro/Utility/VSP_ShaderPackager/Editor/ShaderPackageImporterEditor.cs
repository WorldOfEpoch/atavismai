...
namespace AwesomeTechnologies.ShaderPackager
{
    ...
    public class ShaderPackageImporterEditor : ScriptedImporterEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((typeof(ShaderPackage).Namespace == "JBooth.ShaderPackager") || ShaderPackageImporter.k_FileExtension == ".shaderpack")
        ...
        [MenuItem("Window/Awesome Technologies/Create data packages/Shader Package")]
