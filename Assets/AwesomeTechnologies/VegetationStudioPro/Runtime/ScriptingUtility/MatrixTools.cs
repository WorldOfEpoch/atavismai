...
namespace AwesomeTechnologies.Utility
{
    ...
    {
        public static float3 ExtractTranslationFromMatrix(Matrix4x4 matrix)
        {
            float3 translate;
        ...
        public static quaternion ExtractRotationFromMatrix(Matrix4x4 matrix)
        {
            ...
            return Quaternion.LookRotation(forward, upwards);   // degrees
        }

        public static float3 ExtractScaleFromMatrix(Matrix4x4 matrix)
        {
