...
namespace AwesomeTechnologies.VegetationSystem.Wind
{
    public class HDWindController : IWindController
    {
        ...
        public WindControllerSettings CreateDefaultSettings()
        {
            ...
            {
                windControllerID = WindControllerID,
                heading = "HDWind"
            };
            ...
            Settings.AddTextureProperty("3DNoise", "3D Noise", "", Resources.Load<Texture2D>("ShaderTextures/HDWind/3DNoise"));
            ...
            Settings.AddLabelProperty(" ");
            Settings.AddTextureProperty("GustNoise", "Gust Noise", "", Resources.Load<Texture2D>("ShaderTextures/HDWind/GustNoise"));
        ...
        public void RefreshSettings()
        {
            ...
            NoiseTexture = Settings.GetTexture2DPropertyValue("3DNoise");
            ...
            GustMaskTexture = Settings.GetTexture2DPropertyValue("GustNoise");
        ...
        public void UpdateWind(WindZone windZone, float windSpeedFactor)
        {
            ...
            Shader.SetGlobalFloat(_windSettingsFlexNoiseScale, 1.0f / math.max(0.01f, FlexNoiseWorldSize));
            Shader.SetGlobalFloat(_windSettingsShiverNoiseScale, 1.0f / math.max(0.01f, ShiverNoiseWorldSize));
            ...
            Shader.SetGlobalFloat(_windSettingsGustWorldScale, 1.0f / math.max(0.01f, GustWorldSize));
        }
