...
namespace AwesomeTechnologies.VegetationSystem.Wind
{
    public class CTIWindController : IWindController
    {
        ...
        {
            WindControllerID = "CTIWindController";
        }
        ...
        public void UpdateWind(WindZone windZone, float windSpeedFactor)
        {
            ...
            if (windZone)
            {
                ...
                windStrength += windZone.windPulseMagnitude * (1.0f + math.sin(Time.time * windZone.windPulseFrequency) + 1.0f + math.sin(Time.time * windZone.windPulseFrequency * 3.0f)) * 0.5f;
            ...
            else
            {
                ...
                windStrength += 1 * (1.0f + math.sin(Time.time) + 1.0f + math.sin(Time.time * 3.0f)) * 0.5f;
