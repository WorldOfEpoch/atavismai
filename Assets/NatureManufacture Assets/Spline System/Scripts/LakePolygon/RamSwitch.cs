...
public class RamSwitch : MonoBehaviour
{
    ...
    public void SetProfile(SplineProfile splineProfile)
    {
        ...
        // The following flow map and float speed settings were available in earlier versions of the
        // NatureManufacture spline system but have been removed from the latest API.  Assignments
        // have been commented out to prevent missing-field errors during compilation.
        ...
        // Noise and terrain shaping properties have also been removed from the newer API.
        // They are left here as comments in case you wish to implement your own custom
        // noise or carving logic.
